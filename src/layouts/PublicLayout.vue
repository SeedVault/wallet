    ...
    <div class="container">
      <b-navbar toggleable="lg">
        <router-link :class="navbar-brand" :to="{ name: 'home'}" style="height: 30px;">
          <!-- <img class="navbar-brand-img" src="/images/application_logo_wallet.svg"
          alt="SEED Wallet" /> -->
          <div class="media" style="margin-top: 0px;margin-bottom: 40px;">
            <img class="navbar-brand-img align-self-start mr-3"
            :src="logoImage" style="margin-left:5px;width:30px;height:30px" />
